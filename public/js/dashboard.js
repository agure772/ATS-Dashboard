...
<title>ATS — Admin Truck Solutions</title>
  ...
  <aside class="sidebar">
    ...
    <nav>
      ...
      <div class="nav-section">
        ...
        <button class="nav-item" onclick="navigateTo('tasks-board');setTimeout(()=>tbSwitchView('cs'),200)"><i class="ti ti-headset"></i>CS Board</button>
      </div>
      <div class="nav-section">
  ...
  <main class="main">
    <div class="topbar">
      ...
      <div class="search-box">
        ...
        <input id="global-search" placeholder="Search clients..." oninput="handleSearch(this.value)">
      </div>
      <button class="topbar-btn btn-ghost" onclick="refreshData()"><i class="ti ti-refresh"></i>Sync GHL</button>
      <button class="topbar-btn btn-primary" onclick="openAddClient()"><i class="ti ti-plus"></i>Add Client</button>
    </div>
      ...
      <div id="page-compliance" class="page">
        <div class="table-card">
          <div class="table-topbar">
            <div class="table-title"><i class="ti ti-table"></i>2026 compliance status</div>
            <div class="table-actions">
              <div class="filter-chips" id="filter-chips">
                <button class="chip active" onclick="setFilter(this,'all')">All</button>
                <button class="chip" onclick="setFilter(this,'done')"><i class="ti ti-circle-check"></i> Complete</button>
                <button class="chip" onclick="setFilter(this,'pending')"><i class="ti ti-clock"></i> Pending</button>
                <button class="chip" onclick="setFilter(this,'urgent')"><i class="ti ti-alert-triangle"></i> Urgent</button>
              </div>
              <div class="filter-chips" id="group-chips" style="margin-left:8px;border-left:1px solid var(--border);padding-left:8px">
              ...
              <select id="tag-filter" onchange="setTagFilter(this.value)" style="background:var(--bg2);border:1px solid var(--border);border-radius:8px;padding:5px 10px;color:var(--text);font-size:12px;cursor:pointer;max-width:160px"></select>
              <button class="tbl-btn" onclick="exportCSV()"><i class="ti ti-download"></i>Export</button>
              <button class="tbl-btn primary" onclick="openAddClient()"><i class="ti ti-plus"></i>Add Client</button>
            </div>
          </div>
          ...
          <div class="add-row" onclick="openAddClient()">
    ...
    <div id="page-tasks-board" class="page" style="padding:24px;max-width:1400px;margin:0 auto">
      ...
      <div id="tb-operator-view">
        ...
        <div style="display:flex;gap:10px;align-items:center;margin-bottom:16px;flex-wrap:wrap">
          <div style="position:relative;flex:1;min-width:220px">
            ...
            <input id="tb-search" type="text" placeholder="Search tasks & opportunities..."
      ...
      <div id="tb-cs-view" style="display:none">
        ...
        <div style="display:flex;gap:10px;align-items:center;margin-bottom:16px;flex-wrap:wrap">
          ...
          <div style="display:flex;gap:8px;align-items:center;flex-shrink:0">
            <div style="position:relative">
              ...
              <input id="cs-search" type="text" autocomplete="off" placeholder="Search tasks..."
        ...
        <!-- DOT Quick Update -->
        <div style="margin-top:28px;background:var(--bg2);border:1px solid var(--border);border-radius:14px;overflow:hidden">
          <div style="padding:16px 20px;border-bottom:1px solid var(--border);display:flex;align-items:center;justify-content:space-between">
            <div>
              <div style="font-size:13px;font-weight:800;color:var(--text)"><i class="ti ti-search" style="color:var(--primary);margin-right:6px"></i>DOT Quick Update</div>
              <div style="font-size:11px;color:var(--text3);margin-top:2px">Look up a DOT number and push FMCSA data to the GHL contact</div>
            </div>
            <div style="display:flex;gap:8px;align-items:center">
              <input id="cs-dot-input" type="text" placeholder="Enter DOT number..." onkeydown="if(event.key==='Enter')csDotLookup()"
                style="background:var(--bg3);border:1px solid var(--border);color:var(--text);border-radius:8px;padding:7px 12px;font-size:13px;width:200px">
              <button onclick="csDotLookup()" style="background:var(--primary);color:#0a1a0f;border:none;border-radius:8px;padding:8px 16px;font-size:12px;font-weight:700;cursor:pointer;display:flex;align-items:center;gap:6px">
                <i class="ti ti-search"></i> Search
              </button>
            </div>
          </div>
          <div id="cs-dot-result" style="padding:16px 20px"></div>
        </div>
        ...
        <div style="margin-top:16px;background:var(--bg2);border:1px solid var(--border);border-radius:14px;overflow:hidden">
          <div style="padding:16px 20px;border-bottom:1px solid var(--border);display:flex;align-items:center;justify-content:space-between">
            <div>
              <div style="font-size:13px;font-weight:800;color:var(--text)"><i class="ti ti-zoom-scan" style="color:var(--primary);margin-right:6px"></i>Contact Audit</div>
              <div style="font-size:11px;color:var(--text3);margin-top:2px">Advanced & Recurring contacts with missing fields</div>
            </div>
            <button id="cs-audit-btn" onclick="csRunAudit()" style="background:var(--primary);color:#0a1a0f;border:none;border-radius:8px;padding:7px 16px;font-size:12px;font-weight:700;cursor:pointer;display:flex;align-items:center;gap:6px">
              <i class="ti ti-zoom-scan"></i> Run Audit
            </button>
          </div>
          <div id="cs-audit-results" style="padding:14px 20px"></div>
        </div>
